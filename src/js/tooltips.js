export const tooltips = {
  ...
  'Hilos': 'Hilos CPU. -1 = auto (nº cores físicos). Sube si VAE/CLIP en CPU va lento.',
  'MMap': 'Mapea el modelo a disco en vez de cargarlo entero. Arranque más rápido y menos RAM/VRAM inicial.',
  'Flash Attn': 'Flash Attention global (--fa) para todo el modelo. Ahorra más VRAM que solo diffusion; si está activo, Diffusion Flash se deshabilita.',
  'Diffusion Flash Attn': 'Usa Flash Attention para el modelo de difusión. Acelera la inferencia y reduce VRAM. Requiere soporte de hardware. Si Flash Attn global está activo, este se ignora.',
  ...
  'Strength': 'Controla cuánto se modifica la imagen original. 0 = sin cambios, 1 = regeneración completa. Típico: 0.4-0.7.',
  'Parámetros y flags personalizados': 'Añade flags extra al comando. Un flag por línea.',
}
